...
using Saml2Handler = Local.IdentityModel.Extensions.Saml2SecurityTokenHandler;
using SamlHandler = Local.IdentityModel.Extensions.SamlSecurityTokenHandler;

namespace Local.IdentityModel.Extensions
{
    /// <summary>
